...
def apply_mat(mat: np.ndarray[np.float32], args: np.ndarray[np.float32]) -> np.ndarray[np.float32]:
...
def project(a: np.ndarray[np.float32], b: np.ndarray[np.float32]) -> np.ndarray[np.float32]:
