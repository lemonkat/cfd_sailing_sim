...
def step(
    ...
    return (
        induce(vel_i, bg_vel_i, 3.0, 1),
        induce(vel_j, bg_vel_j, 3.0, 1),
        induce(dens, bg_dens, 3.0, 1),
    )
...
#             self.vel_j,
#             self.dens,
#             tf.constant(self.current.x, dtype=FLOAT),
#             tf.constant(self.current.y, dtype=FLOAT),
#             tf.constant(1.0, dtype=FLOAT),
#             tf.constant(dt, dtype=FLOAT),
#         )
#         self.vel_i.assign(vel_i)
#         self.vel_j.assign(vel_j)
#         self.dens.assign(dens)
...
#         #     induce(
#         #         vel_i,
#         #         ctt(self.current[0], dtype=FLOAT),
#         #         ctt(3, dtype=INT),
#         #         ctt(1.0, dtype=FLOAT),
#         #     )
#         # )
...
#         #     induce(
#         #         vel_j,
#         #         ctt(self.current[1], dtype=FLOAT),
#         #         ctt(3, dtype=INT),
#         #         ctt(1.0, dtype=FLOAT),
#         #     )
#         # )
#         # self.dens.assign(
#         #     induce(
#         #         dens, ctt(1.0, dtype=FLOAT), ctt(3, dtype=INT), ctt(1.0, dtype=FLOAT)
#         #     )
#         # )
